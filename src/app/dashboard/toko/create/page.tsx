...
import { postStore } from "@/repositories/store";
...
const Page = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      await postStore(values);
      toast.success("Toko berhasil ditambahkan", { description: "Anda akan segera dikembalikan ke halaman utama." });
      router.push("/dashboard/toko");
    } catch (error) {
      errorHandling(error, "Toko Gagal ditambahkan");
    }
  };
